...
public class ImageServiceImpl implements ImageService {
	...
	@Override
	public Image uplaodImagePc(MultipartFile file,Long idPc) throws IOException {
		// Récupérer le PC depuis la DB
	    Pc p = pcRepository.findById(idPc)
	            .orElseThrow(() -> new RuntimeException("PC not found"));

	    // Créer l'image et lier au PC existant
